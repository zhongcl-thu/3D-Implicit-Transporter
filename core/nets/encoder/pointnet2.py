...
from pointnet2_utils import etw_pytorch_utils as pt_utils
from collections import namedtuple
import torch.nn.functional as F
from pointnet2_utils import utils as pointnet2_utils
...
class Pointnet2SSG(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.FP_modules.append(
            PointnetFPModule(mlp=[128 + 3, 128, 128, 128])
        )
        ...
        self.FC_layer = (
            ...
            .conv1d(128, bn=True)
            .dropout()
            .conv1d(cfg.num_classes, activation=None)
        )
    ...
    def forward(self, pointcloud):
        ...
        embedding = self.FC_layer(l_features[0]).transpose(1, 2).contiguous()
        return embedding


SaliencyModel = Pointnet2SSG
CorrespondenceModel = Pointnet2SSG

if __name__ == '__main__':
    input = torch.randn((8, 3, 2048)).cuda()
    net = Pointnet2SSG(64).cuda()
